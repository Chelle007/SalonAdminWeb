...
<%
        ...
        java.io.PrintWriter log = new java.io.PrintWriter(new java.io.FileWriter(gen.getDataLogFileQuery(), true), true);
          ...
          String[] cond=new String[0];   
            String[] judul=new String[]{"SEQ","c","CODE","DESCRIPTION","CURRENCY"};  //
            String COL= "'Id','','Code','Description','Currency'";
        ...
        ses.setAttribute("CODE",data);
            if(gen.gettable(request.getParameter("tpx")).equalsIgnoreCase("Download")){
                  ...
                  java.util.Vector judulx=gen.getElement(',',"SEQ,CODE,DESCRIPTION,CURRENCY,");                  
...
<![endif]-->
		...
		<script type="text/javascript">
            function down(){
                location.href="bankcode.jsp?tp=<%=tp%>&tb=<%=tp%>&tpx=Download";
            }
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
                        ...
                        {name:'x',index:'x', width:1,editable: true, editoptions:{size:"1",maxlength:"7"}},
						{name:'code',index:'code', width:30,editable: true, editoptions:{size:"10",maxlength:"7"}},
						{name:'description',index:'description', width:150,editable: true,editoptions:{size:"40",maxlength:"100"}},
                        {name:'curr',index:'curr', width:150, editable: true,edittype:"select",editoptions:{value:"IDR:Rupiah;SGD:Dolar Singapore;USD:Dolar US;EUR:Euro;CNY:Yuan"}}
