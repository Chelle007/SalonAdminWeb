							...
							<div class="col-xs-12">
								...
								<div>
									<div id="user-profile-3" class="user-profile row">
                						...
                						<form class="form-horizontal" name="BGA" method="POST" action="jobacct.jsp?tp=<%=tp%>" >
											...
											<tbody>
												...
												<tr>
                                                       ...
                                                       %>
                                                            ...
                                                            <%if(ss==0){%>
                                                            <a href="jobcompleted.jsp?tp=JOBACCTDETAIL&canedit=true&S1=<%=gen.gettable(data.get(s+ss)).trim()%>&S2=<%=gen.gettable(data.get(s+ss+1)).trim()%>"><%=gen.gettable(data.get(s+ss)).trim()%></a>
                                                            <%}else{
                                                                if(ss<7 || ss==10){
