...
%>
	...
	<body class="skin-2"   <%if(gen.gettable(request.getParameter("tpx")).startsWith("Download")){%> onload="pop()"<%}%>>
			...
			jQuery(function($) {
				...
				*/
                ...
                switch ("<%=tp%>") { // ubah sini
                    case "P_EMPLOYEE":
                        colModel = [
                           ...
                           {name:'Manage_level', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"7"}},
                           ...
                           {name:'Join_date', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                           {name:'Resign_date', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                           {name:'Salary_percentage', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                           {name:'Salary_amount', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                           {name:'Salary_type', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}}
                       ];
                        break;
                    case "P_MEMBER":
                        colModel = [
                    ...
                    case "S_ITEM":
                        colModel = [
                            ...
                            {name:'Cat', index:'', width:20, editable: true, editoptions:{size:"10", maxlength:"10"}},
				...
				jQuery(grid_selector).jqGrid({
					...
					editurl: "master.jsp?tp=<%=tp%>&act=save",
