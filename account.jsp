...
<%
        ...
        String[] judul = new String[]{"ID", "Account", "Description", "ParentAccount"};
        String prefix = "";
        // ubah sini
	 ...
	 /*   java.util.Enumeration enu = request.getParameterNames();
 	    while (enu.hasMoreElements()){
             ...
             System.out.println(pr+"="+request.getParameter(pr));
                    ...
                    for (int i = 1; i < addArray.length; i++) {
                        addArray[i] = gen.gettable(request.getParameter(judul[i+1]));
                      //  System.out.println(i+"="+addArray[i]);
                    }
...
<![endif]-->
		...
		<script type="text/javascript">
            ...
            function down(){
                location.href="account.jsp?tp=<%=tp%>&title=<%=title%>&tb=<%=gen.gettable(request.getParameter("tp"))%>&Y11=<%=gen.gettable(request.getParameter("tp"))%>&tpx=Download";
            }
			...
			jQuery(function($) {
				...
				*/
                    ...
                    var    colModel = [
                           ...
                           {name:'Account', index:'', width:10, editable: true, editoptions:{size:"10", maxlength:"30"}},
                           {name:'Description', index:'', width:20,editable: true, editoptions:{size:"30", maxlength:"30"}},
                           {name:'ParentAccount', index:'', width:10, editable: true, editoptions:{size:"10", maxlength:"30"}},
                        ]
				...
				jQuery(grid_selector).jqGrid({
					...
					editurl: "account.jsp?tp=<%=tp%>&act=save",
