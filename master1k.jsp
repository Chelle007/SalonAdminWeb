...
%>
	...
	<body class="no-skin"   <%if(gen.gettable(request.getParameter("tpx")).startsWith("Download")){%> onload="pop()"<%}%> <%if(gen.gettable(request.getParameter("act")).startsWith("save")){%> onload="xfresh()"<%}%> >
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
                       ...
                       <% System.out.println(tp+",151data.size()="+data.size());%>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
		...
		<script type="text/javascript">
            ...
            for(int m=0;m<data.size();m+=judul.length){
                ...
                hit++;
                       ...
                       System.out.println(tp+",232data.size()="+data.size());
            %>
			];
			...
			jQuery(function($) {
				...
				*/
                ...
                switch ("<%=tp%>") { // ubah sini
                    case "P_EMPLOYEE":
                        colModel = [
                           ...
                           {name:'E_ID', index:'', width:20, editable: true, editoptions:{size:"10", maxlength:"7"}},
                           {name:'Name', index:'', width:100, editable: true, editoptions:{size:"20", maxlength:"60"}},
                           {name:'Manage_level', index:'', width:50, editable: true, editoptions:{size:"1", maxlength:"1"}},
                           {name:'Address', index:'', width:50, editable: true, editoptions:{size:"30", maxlength:"60"}},
                           {name:'Contact_no', index:'', width:50, editable: true, editoptions:{size:"15", maxlength:"15"}},
                           {name:'Join_date', index:'', width:50, sorttype:"date", unformat: pickDate, editable: true, editoptions:{size:"10", maxlength:"10"}},
                           {name:'Resign_date', index:'', width:50, sorttype:"date", unformat: pickDate, editable: true, editoptions:{size:"10", maxlength:"10"}},
                           {name:'Salary_percentage', index:'', width:50, editable: true, editoptions:{size:"5", maxlength:"5"}},
                           {name:'Salary_amount', index:'', width:50, editable: true, editoptions:{size:"12", maxlength:"20"}},
                           {name:'Salary_type', index:'', width:50, editable: true, editoptions:{size:"1", maxlength:"1"}}
                       ];
                        break;
                    case "P_MEMBER":
                        colModel = [
                            ...
                            {name:'Category', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"7"}},
                            {name:'Address', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Contact_no', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}}
                        ];
                        break;
                    case "P_SUPPLIER":
                        colModel = [
                            ...
                            {name:'Name', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"100"}},
                            {name:'Address', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"500"}},
                            {name:'Contact_no', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"15"}},
                            {name:'Payment_grace_period', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}}
                        ];
                        break;
                    case "P_AGENT":
                        colModel = [
                            ...
                            {name:'Address', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"500"}},
                            {name:'Contact_no', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"15"}},
                            {name:'Agent_fee_percentage', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}}
                        ];
                        break;
                    case "S_BANK":
                        colModel = [
                    ...
                    case "S_ITEM":
                        colModel = [
                            ...
                            {name:'Item_desc', index:'', width:100, editable: true, editoptions:{size:"10", maxlength:"100"}},
                            {name:'Cat', index:'', width:30, edittype:"select", editable: true, editoptions:{value:"S:S; NS:NS", size:"10", maxlength:"10"}},
                            {name:'Qty', index:'', width:20, editable: true, editoptions:{size:"10", maxlength:"10"}},
                            {name:'Unit_type', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"20"}},
                            {name:'Report_unit', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Volume_per_unit', index:'', width:60, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Purchase', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Sales_1', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Sales_2', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Sales_3', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Sales_4', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}},
                            {name:'Min_stock', index:'', width:50, editable: true, editoptions:{size:"10", maxlength:"30"}}
                        ];
                        break;
                }
				...
				jQuery(grid_selector).jqGrid({
					...
					editurl: "save.jsp?tp=<%=tp%>&act=save",
