...
<%
        ...
        // ubah sini
        String[] judul = new String[]{"CP_ID", "Descriptions", "Member_category", "Price"};
        String prefix = "CP";
        String detailTp = "S_CARD_PACKAGE_DETAIL";
        String detailTitle = "CardPackage Used";
        String[] judulDetail = new String[]{"Card_id", "Quantity"};
        String maplistType = "CARD";
        String detailPrefix = "CPD";
        ...
        if (detailData.size()==0) {
            for (int i=0; i<judulDetail.length+1; i++) {
                if(i==2) detailData.addElement("0");
